  ...
  return (
    <div className="pt-6 relative min-h-screen bg-background text-foreground overflow-x-hidden transition-colors duration-300">
      ...
      <main className="relative">
        <div className="space-y-12 md:space-y-6 pt-12 grid grid-cols-1 md:grid-cols-2 px-6 md:px-20">
          <div className="">
            <h1 className="text-left text-5xl lg:text-[4.5rem] font-medium capitalize leading-none tracking-tight text-zinc-900 dark:text-white">
              One tap. 
            ...
            <p className="text-left my-10 text-lg text-zinc-500 dark:text-neutral-500">
              Unlock exclusive early access to a ground-breaking to respond to
              emergencies! <br className="hidden md:block" />
              Subscribe now and stay ahead of the future!
            </p>
            <div className="bg-white dark:bg-zinc-900/40 backdrop-blur-lg border border-zinc-200 dark:border-zinc-800/60 rounded-full w-full max-w-lg md:w-3/4 shadow-xl dark:shadow-none overflow-hidden">
              <form onSubmit={handleJoin} className="flex">
                <input
                  ...
                  className="px-6 py-3 bg-transparent text-zinc-900 dark:text-white rounded-full outline-none focus:outline-none disabled:opacity-50 w-full"
                  placeholder="Your email"
                />
                <button
                  type="submit"
                  disabled={status === "loading"}
                  className="flex items-center gap-2 text-nowrap bg-zinc-900 dark:bg-white text-white dark:text-black hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-all cursor-pointer py-3 px-8 rounded-full font-medium disabled:opacity-50 shadow-lg dark:shadow-none active:scale-95"
                >
                  <p>{status === "loading" ? "Joining..." : "Join waitlist"}</p>
                </button>
              </form>
            </div>
            {status === "error" && (
            ...
            <div className="flex items-center justify-start my-5">
              <div className="">
                ...
                <p className="text-zinc-500 dark:text-white/40 text-sm my-2 ml-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8 mx-10 md:mx-60 mt-24 md:mt-80 mb-20 text-zinc-900 dark:text-white">
